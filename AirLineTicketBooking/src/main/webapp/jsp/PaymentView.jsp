...
<body>
	...
	<div class="main-wrap">
		...
		<table class="table table-striped">
			...
			<tbody>
				<tr>
					<td><b>Flight No.:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=fBean.getFlightNo()%>
					</td>
			...
			<thead>
				<tr>
					...
					<th data-sort="name" colspan="2">Your Detail
				...
				<div class="panel-body">
					<form method="post" action="<%=ATBView.BOOK_CTL%>">
						...
						<div class="form-group required">
							<label class="control-label col-md-4  requiredField">Card
						...
						<div class="form-group required">
							<label class="control-label col-md-4  requiredField">Card
								Holder Name <span class="asteriskField">*</span>
							</label>
							<div class="controls col-md-8 ">
								<input class="input-md  textinput textInput form-control"
						...
						<div class="form-group required">
							<label class="control-label col-md-4  requiredField">CVV
								No. <span class="asteriskField">*</span>
							</label>
							<div class="controls col-md-8 ">
								<input class="input-md  textinput textInput form-control"
