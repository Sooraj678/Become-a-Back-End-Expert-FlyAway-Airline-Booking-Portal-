...
%>
  ...
  <form action="<%=ATBView.CONTACT_CTL%>" method="post">
    ...
    <input type="number" id="phone" name="phone" placeholder="Your Mobile Number.." required><br>
    <label for="lname">Your Email ID!!</label>
    <input type="email" id="email" name="email" placeholder="Your Your Email ID.." required><br>
    ...
    <textarea id="subject" name="query" placeholder="Write something.." style="height:200px" required></textarea>
